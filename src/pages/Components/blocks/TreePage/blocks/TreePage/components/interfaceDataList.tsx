export const interfaceDataList = {
  ...
  data: {
    ...
    status: 0, //0:不允许校准诊断  1:未开始校准诊断  2:校准诊断中
    ...
    boards: [
      //单板列表
      {
        ...
        disabled: false, //是否禁用(禁用checkbox，还需要可以展开)（如果为真则其子状态也为真）
        children: [
          //子节点
          {
            key: '0-AC-0',
            ...
            status: 0, //测试大类状态  0：未开始 1：进行中  2：完成 3：异常 4：检测环境
            disabled: false, //是否禁用
            ...
            children: [
              {
                key: '0-AC-0-0',
                title: 'Check', //测试小类描述
                status: 2, //测试小类状态  0：未开始 1：进行中  2：完成 3：异常
                disabled: true, //是否禁用
                select: true, //是否选中
              },
              {
